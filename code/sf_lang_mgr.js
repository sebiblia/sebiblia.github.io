...
const shortcuts = {
	history: { key:'h', comb: 'CTRL+A+H', },
	examples: { key:'e', comb: 'CTRL+A+E', },
};
...
const msg_es = {
	...
	history: `HISTORIA DE COMANDOS (CTRL+A+H)`,
	examples: `EJEMPLOS (CTRL+A+E)`,
	...
	reset_history: `INICIAR HISTORIA (CTRL+A+I)`,
	save_result: `SALVAR RESULTADO (CTRL+A+U)`,
	debug: `DEPURAR (CTRL+A+D)`,
	history_name: "NOMBRE:",
	save_button: "GUARDAR",
...
const msg_en = {
	...
	reset_history: `INIT HISTORY (CTRL+A+I)`,
	save_result: `SAVE RESULT (CTRL+A+U)`,
	debug: `DEBUG (CTRL+A+D)`,
	history_name: "NAME:",
	save_button: "SAVE",
	load_button: "LOAD",
