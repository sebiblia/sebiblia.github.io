...
Este campo va de la mano con el campo de [Presentación](#presentación-de-versiculos-resultado-p) por eso cuando se cambia este campo el otro tambien cambia al mismo color.
...
Estos comandos establecen en que tipo de caracteres se escriben los versiculos. Sirven mas que todo cuando los versiculos resultado se estan mostrando de los textos en los idiomas ORIGINALES.

Son equivalentes a modificar desde la interfaz [gráfica](#interfaz-básica) el campo P y que se denominó [Presentacion](#interfaz-básica).
